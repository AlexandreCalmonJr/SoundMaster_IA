...
const ROUTE_MAP = {
    ...
    'coverage-map':      { path: 'pages/coverage-map.html',      title: 'Mapa de Cobertura',   category: 'Medir' },
    ...
    'delay-align':       { path: 'pages/delay-align.html',       title: 'Alinhamento Delay',   category: 'EQ' },
...
class Router {
    constructor() {
        ...
        this.scriptPaths = {
            ...
            'coverage-map': 'js/pages/coverage-map-page.js',
            ...
            'ir-measurement': 'js/pages/ir-measurement-page.js',
            'eq': 'js/pages/eq-page.js',
            'auto-eq': 'js/pages/auto-eq-page.js',
    'delay-align': 'js/pages/delay-align-page.js',
    ...
    _getPageModuleName(pageId) {
        const map = {
            ...
            'delay-align': 'DelayAlignPage',
            'ir-measurement': 'IRMeasurementPage',
        };
